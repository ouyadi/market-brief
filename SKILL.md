...
description: Install or maintain market-brief, a scheduled Codex/Claude task that scans Discord and WeChat investing chats, writes an hourly report, pushes it to WeChat, and optionally runs an inbound WeChat listener with MCP tools. Requires chatlog, wxstore, and discord-selfbot MCP servers.
---
